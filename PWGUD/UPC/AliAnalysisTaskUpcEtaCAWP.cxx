...
AliAnalysisTaskUpcEtaCAWP::AliAnalysisTaskUpcEtaCAWP() //first constructor, contains all histograms
	...
	fHistNeventsEtaC(0), fMPiKvsMPiK(0),
	...
	fHistNeventsEtaCRhoChannel(0), f4PiVs2PiMinv(0), f4PiVs2PiMinvSquared(0), fM2PiPiVsM2PiPi(0),
...
void AliAnalysisTaskUpcEtaCAWP::UserCreateOutputObjects() //use the names defined in the constructor to makes specific data structures
{
	...
	f4PiVs2PiMinv = new TH2D("f4PiVs2PiMinv", "f4PiVs2PiMinv", 600, 0., 6., 500, 0., 5.);
	...
	fM2PiPiVsM2PiPi = new TH2D("fM2PiPiVsM2PiPi", "fM2PiPiVsM2PiPi", 600, 0., 6., 500, 0., 5.);
	...
	if (nGoodTracks == 4 && nSpdHits > 1) {
		...
		if ((nPion == 4)) {
			...
			if ((qPion[0] + qPion[1] + qPion[2] + qPion[3]) == 0) {
				...
				//Dalitz plots -- For all cases look at 4pi vs 2pi minv
